...
public class Student implements Comparable {
	...
	System.out.print("Student full name is:" Student.getfullName);
	...
	System.out.print("Date of birth is:" Student.getbirthDate);
	Student birthDate=new.birthday("    -  -  ");

	/**
	 * student average mark
	 */
	private double avgMark;
	System.out.print("avgmarks is:" Student.getavgMark);
	Student avgMark=new.avgMark();
